...
var categories_name = ['Психология','Детективы','Книги для родителей','Любовь и личные отношения','Заработок','Топ 120','Художественная литература',];
  var string_text = """
  Александр Пушкин
...
1822 г.
  """;
var book_as_famali = ["Братья и Сестры. Как помочь вашим детям жить дружно", "Как любить ребенка","Что делать, чтобы дети… Вопросы и ответы", "Родителям книга вопросов и ответов",
...
var book_as_parenting = [
  ...
  "Город и псы",
  "Машины как я",
  "Шмитт Оскар и Розовая Дама и другие истории",
...
var book_as_love = [];
var book_as_earnings = [];
var book_as_top120 = [];
var book_as_fiction = [];
var book_as_parents = [];
var book_as_psychology = [];
var book_as_detectives = [];


List<Widget> extractedChildren = <Widget>[];


// https://cv2.litres.ru/pub/c/cover_max1500/6029429.jpg
List<String> extraNameChild = <String>[];
List<String> extraimgChild = <String>[];
