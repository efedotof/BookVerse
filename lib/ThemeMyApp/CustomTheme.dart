...
class CustomTheme with ChangeNotifier{
  ...
  static ThemeData get lightTheme { //1
    ...
    highlightColor: Color(0xFFBBC5C1),
    indicatorColor: Color(0xFF4F5053),
       focusColor:  Color(0xFF62697B),
        cardColor:  Color(0xFFF6F5FA),
  ...
  static ThemeData get darkTheme {
    ...
    highlightColor: Color(0xFF597980),

    textTheme: TextTheme(
      bodyText1: TextStyle(color: Color(0xFF414A63), fontSize: 15)
    ),
    indicatorColor: Color(0xFF738C97),
        cardColor:  Color(0xFF33384B),
        primaryColor: Color(0xFF131E34),
         bottomNavigationBarTheme: BottomNavigationBarThemeData(
